...
('user1', 'hashpassword1', 'member'),
('user2', 'hashpassword2', 'librarian'),
('user3', 'hashpassword3', 'member'),
('user4', 'hashpassword4', 'member'),
('user5', 'hashpassword5', 'librarian'),
('user6', 'hashpassword6', 'member'),
('user7', 'hashpassword7', 'member'),
('user8', 'hashpassword8', 'librarian'),
('user9', 'hashpassword9', 'member'),
('user10', 'hashpassword10', 'librarian');
*/
